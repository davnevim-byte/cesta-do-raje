...
export const CONGREGATION_SCENARIOS = [
  ...
  // ── Regionální sjezd + Přednáška pro veřejnost ──────────
  {
    ...
    situation: "Skupinka bratri a sester se bavi po shromazdeni o regionalnim sjezdu ktery byl minuly mesic. Moderator te pozada abys sdelil/a nejvetsi pouceni ze sjezdu.",
    roleA: "Jsi na tahu. Sdilis konkretni pouceni nebo moment ze sjezdu ktery te zasahl.",
    roleB: "Hraješ moderatora ({targetPlayer}). Rekni: '{currentPlayer}, co te na letosnim regionalnim sjezdu nejvice oslovilo?'",
    objection: "Co te na letosnim regionalnim sjezdu nejvice oslovilo?",
    goal: "Sdilet konkretni pouceni ze sjezdu — priznak nebo prednaska ktera te oslovila. Propojit s osobnim zivotem.",
    timeSeconds: 90,
    hint: "Bud konkretni. Rekni co konkretni te oslovilo a proc.",
