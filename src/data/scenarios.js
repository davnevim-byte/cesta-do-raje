...
// ─────────────────────────────────────────────
  // ── Regionální sjezd + Přednáška pro veřejnost ──────────
  {
    ...
    situation: "Skupinka bratri a sester se bavf po shromazdeni o regionálním sjezdu ktery byl minuly mesic. Moderator te pozada abys sdelil/a nejvetsi pouceni ze sjezdu.",
    roleA: "Jsi na tahu. Sdilis konkretni pouceni nebo moment ze sjezdu ktery te zasahl.",
    roleB: "Hraješ moderatora ({targetPlayer}). Rekni: '{currentPlayer}, co te na letosnim regionálním sjezdu nejvice oslovilo? Mohl/a bys se s nami podelit?'",
    objection: "Co te na letosnim regionálním sjezdu nejvice oslovilo?",
    goal: "Sdilet konkretni pouceni ze sjezdu — prichod nebo prednaska ktera te oslovila. Propojit s osobnim zivotem.",
    timeSeconds: 90,
    hint: "Bud konkretni — ne jen 'bylo to hezke'. Rekni co konkretni te oslovilo a proc.",
  ...
  },
  {
    ...
    difficulty: "medium",
    category: "sborovy zivot",
    title: "Pozvani na přednášku pro veřejnost",
    setting: "Setkani se znamym ktery neni svedkem",
    situation: "V sobotu je v salu Království přednáška pro veřejnost na tema 'Kde najit odpovedi na nejdulezitejsi zivotni otazky'. Potkáš znamého a chces ho pozvat.",
    roleA: "Jsi svedek Jehosuv. Znas tohoto cloveka — nie je to kdo se nikdy neinteresoval o Bibli.",
    roleB: "Hraješ znamého ({targetPlayer}). Jsi uprimny ale hesitujici. Rekni: 'Přednáška? To je jako kosteni ne? Ja do kostela nechodim...'",
    objection: "Přednáška? To je jako kosteni ne? Ja do kostela nechodim.",
    goal: "Laskave vysvetlit ze se nejedna o kosteni ale o verejnou prednašku o Bibli — vstup zdarma, zadne koleky, bez zavazku. Nacítnout tema nebo obsah.",
    timeSeconds: 120,
    hint: "Rekni: 'Neni to kosaeni — je to bezplatna prednáška pro kohokoliv. Tema je...' Bud konkretni o obsahu, ne o nabozenství.",
  ...
  },
  {
    ...
    difficulty: "medium",
    category: "sborovy zivot",
    title: "Obvodní shromáždění — sdílení s rodinou",
    setting: "Rodinny rozhovor pred obvodním shromáždením",
    situation: "Blizi se obvodní shromáždění. Deti se ptají proc na nej jedete — jedna z nich rika ze nerozumi proc je dulezite tam jet kdyz shromazdeni maji kazdy tyden.",
    roleA: "Jsi rodic — svedek Jehosuv. Chces detem vysvetlit proc je obvodní shromáždění specialni.",
    roleB: "Hraješ dite ({targetPlayer}). Jsi zvídavý. Rekni: 'Proc jedeme az tam? Veď shromazdeni mame tady? Nebude to nudne?'",
    objection: "Proc jedeme az tam? Vedf shromazdeni mame tady. Nebude to nudne?",
    goal: "Laskave vysvetlit co je obvodní shromáždění — setkani vice sboru, specialni program, bratri ze vsech koutku. Pridat osobni zkusenost co te na sjezdech tesi.",
    timeSeconds: 120,
    hint: "Bud uprimny — rekni co TY osobne mas na obvodních shromážděních rád/a. Deti cití uprimnost.",
    successCriteria: "Skupina hlasuje: vysvetleni bylo uprimne a motivovalo ke sjezdu?",
  },
  {
    id: "SBOR_15",
    difficulty: "hard",
    category: "sborovy zivot",
    title: "Kolega se ptá na sjezd — cena a organizace",
    setting: "Praci — kolega se dozvedel ze jedes na sjezd",
    situation: "Kolega v praci se dozvedel ze jedes na regionální sjezd. Je zvídavý — jak je to organizovano, kdo za to plati, kdo prednasi.",
    roleA: "Jsi svedek Jehosuv v praci. Mas s tim kolegou dobrý vztah.",
    roleB: "Hraješ kolegu ({targetPlayer}). Jsi zvídavý. Rekni: 'Tak vy máte sjezd? To je jako vasna konvence nebo jak? Kdo to organizuje a kdo za to plati?'",
    objection: "Vy máte sjezd? Jak je to organizovano? Kdo za to plati?",
    goal: "Prirozene vysvetlit ze regionální sjezd organizuji svedkove dobrovolne, vstup je zdarma, zadne sbírky. Zmínit ze bratri pracuji jako dobrovolnici. Nabidnout pozvání.",
    timeSeconds: 150,
    hint: "Zduraznit: dobrovolna prace, zadne sbírky, vstup zdarma pro kohokoliv. 2. Korintanum 9:7 — Buh miluje radostneho davce.",
    successCriteria: "Skupina hlasuje: vysvetleni bylo jasne a pozitivne prezentovalo organizaci?",
  },
